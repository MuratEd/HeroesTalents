...
public class Hero {
    ...
    public void setStats(String id,double hp,double hpRegen,double mana,double manaRegen,double attackPerSec,double attackRange,double attackDamage,int physicalArmor,int magicalArmor) {
